const RandomSerie = ({from=10, to=15, wavePeriod=1, waveScale=0, rand=0.2, dataSets=50, dataSetBegin=1, dataSetEnd=50}) => {
    const result = [];
...
const Generator = {
    outside_temperature: () => RandomSerie({from: -3, to: 10, wavePeriod: 0.5, waveScale: 5, rand: 0.5}),
    inside_temperature: () => RandomSerie({from: 18, to: 20, wavePeriod: 6, waveScale: 0.5, rand: 0.2}),
